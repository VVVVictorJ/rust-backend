...
use crate::models::job_execution_history::{
    JobExecutionHistory, NewJobExecutionHistory, UpdateJobExecutionHistory,
};
...
/// 删除指定ID的记录
#[allow(dead_code)]
pub fn delete(conn: &mut PgConnection, history_id: i32) -> Result<usize, DieselError> {
